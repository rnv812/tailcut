...
const show = async (doc: Doc, selectedId: string | null = 'c1', material: EditContext = ctx) => {
  const dispatch = vi.fn()
  render(
    <Clips doc={doc} ctx={material} selectedId={selectedId} playhead={7} fps={25} dispatch={dispatch} />,
    host,
  )
  await settled()
  return dispatch
